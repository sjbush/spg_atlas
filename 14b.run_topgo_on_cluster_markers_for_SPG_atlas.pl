...
# REQUIREMENTS
my $resolution = 1.1; # 1.2; # 0.3;
my $clusters = "/project/GorielyLab2021/sbush/human_adult_SSCs/results/states0to4.degs_All_vs_All_resolution_$resolution.txt"; # from 10.run_DEG_for_States0to4.R
...
# OUTPUT
my $out_dir 			  = "/project/GorielyLab2021/sbush/human_adult_SSCs/results/states0to4.go_terms_per_cluster.resolution_$resolution.min_log_fc_$min_logfc";
if (!(-d($out_dir))) { mkdir $out_dir or die $!; }
my $out_dir_for_go_script = "/project/GorielyLab2021/sbush/human_adult_SSCs/results/states0to4.go_enrichment_per_cluster.resolution_$resolution.min_log_fc_$min_logfc";
my $r_script 			  = "/project/GorielyLab2021/sbush/human_adult_SSCs/run_topgo_analysis_resolution_$resolution"."_min_log_fc_$min_logfc.R";
