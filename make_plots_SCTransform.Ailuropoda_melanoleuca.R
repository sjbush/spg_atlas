...
# the t2g file is at /project/GorielyLab2021/sbush/ssc_atlas/indexes/Ailuropoda_melanoleuca/t2g2.txt
...
tr2g <- read_tsv("/project/GorielyLab2021/sbush/ssc_atlas/indexes/Ailuropoda_melanoleuca/t2g2.txt", col_names = c("transcript", "gene", "gene_name")) # HARD-CODED
