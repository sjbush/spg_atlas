...
clusters = pd.read_csv("/project/GorielyLab2021/sbush/human_adult_SSCs/results/states0to4.clusters.res1.1.csv")
...
scv.pl.velocity_embedding_stream(sample, basis = 'umap', dpi = 300, color = 'clusters', palette={"state 0": "orange", "state 0A/1": "green", "state 0B": "red", "SPG": "yellow", "diff SPG": "pink", "leptotene": "cornflowerblue", "zygotene": "blueviolet"}, save = 'states0to4.velocity_embedding_stream.res1.1.png')
scv.pl.velocity_embedding(sample, basis = 'umap', dpi = 300, color = 'clusters', palette={"state 0": "orange", "state 0A/1": "green", "state 0B": "red", "SPG": "yellow", "diff SPG": "pink", "leptotene": "cornflowerblue", "zygotene": "blueviolet"}, save = 'states0to4.velocity_embedding.res1.1.png')