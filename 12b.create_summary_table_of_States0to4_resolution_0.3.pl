...
my $total_sscs_in_atlas  = 2232; # i.e. the number of cells in clusters 1 and 2. Count can be obtained from states0to4.metadata.txt, produced by 8.subset_whole_testes_atlas_to_obtain_States0to4.R
my $total_non_sscs_in_atlas = $total_cells_in_atlas-$total_sscs_in_atlas;
my @cluster_order = ("Cluster 1","Cluster 2","Cluster 3","Cluster 0");
...
my $cluster0_name = 'SPERMATOCYTE';
my $cluster1_name = 'STATE 0';
my $cluster2_name = 'STATE 1';
my $cluster3_name = 'SPERMATOGONIA';
my %cluster_names = (
'Cluster 0' => 'spermatocyte',
'Cluster 1' => 'state 0',
'Cluster 2' => 'state 1',
'Cluster 3' => 'spermatogonia'
);
...
my $fatal = 0;
my @in_files = ($pheno_file,$id_to_reactome,$reactome_descs,$orthologues,$markers,$genelist1,$genelist2,$genelist3,$genelist4,$genelist5,$genelist6,$t2g,$proporp1,$proporp2,$proporp3,$proporp4,$num1,$num2,$num3,$num4,$expr1,$expr2,$expr3,$expr4,$twist_no_cov);
...
print OUT "Total number of undifferentiated SSCs (i.e. CLUSTER 1 + CLUSTER 2) in which this gene is detected\t% of undifferentiated SSCs (i.e. CLUSTER 1 + CLUSTER 2) in which this gene is detected\t";
print OUT "Total number of non-SSC cells in which this gene is detected (i.e. CLUSTER 0 + CLUSTER 3)\t% of non-SSC cells in which this gene is detected (i.e. CLUSTER 0 + CLUSTER 3)\t";
...
foreach my $gene_name (@sorted_gene_names)
	{ my $gene_id = '.';
	  ...
	  my $tot_cells_in_which_gene_detected 	  = $ct{$gene_name}{'Cluster 0'}+$ct{$gene_name}{'Cluster 1'}+$ct{$gene_name}{'Cluster 2'}+$ct{$gene_name}{'Cluster 3'};
	  my $pct_cells_in_which_gene_detected 	  = sprintf("%.3f",(($tot_cells_in_which_gene_detected/$total_cells_in_atlas)*100));
	  my $tot_sscs_in_which_gene_detected  	  = $ct{$gene_name}{'Cluster 1'}+$ct{$gene_name}{'Cluster 2'};
	  my $pct_sscs_in_which_gene_detected  	  = sprintf("%.3f",(($tot_sscs_in_which_gene_detected/$total_sscs_in_atlas)*100));
	  my $tot_non_sscs_in_which_gene_detected = $ct{$gene_name}{'Cluster 0'}+$ct{$gene_name}{'Cluster 3'};
	  ...
	  my $orthologue_line = ".\t.\t.\t.\t.\t.";
	  my $de_in_cluster0 = 'no'; my $de_in_cluster1 = 'no'; my $de_in_cluster2 = 'no'; my $de_in_cluster3 = 'no';
	  ...
	  if ($number_of_clusters_in_which_this_gene_is_de == 0)
		{ print OUT "$gene_name\t$gene_id\t$gene_desc\t$gene_type\t$loc\t$orthologue_line\t$phenotype\t$source\t$reactome_ids\t$reactome_descs\t$is_this_gene_on_the_oncogenic_mapk_pathway\t";
		  print OUT "$ct{$gene_name}{'Cluster 1'}\t$ct{$gene_name}{'Cluster 2'}\t$ct{$gene_name}{'Cluster 3'}\t$ct{$gene_name}{'Cluster 0'}\t";
		  ...
		  print OUT "$pct{$gene_name}{'Cluster 1'}\t$pct{$gene_name}{'Cluster 2'}\t$pct{$gene_name}{'Cluster 3'}\t$pct{$gene_name}{'Cluster 0'}\t";
		  print OUT "$avg{$gene_name}{'Cluster 1'}\t$avg{$gene_name}{'Cluster 2'}\t$avg{$gene_name}{'Cluster 3'}\t$avg{$gene_name}{'Cluster 0'}\t";
		  print OUT "$number_of_clusters_in_which_this_gene_is_de\t.\t.\t.\t.\t.\t.\t.\t.\t.\t$de_in_cluster1\t$de_in_cluster2\t$de_in_cluster3\t$de_in_cluster0\t";
		...
		{ my $de_line_state = ''; my $de_line_pct_1 = ''; my $de_line_pct_2 = ''; my $de_line_diff = ''; my $de_line_logfc = ''; my $de_line_p_val = ''; my $de_line_adj_p = '';
		  ...
		  print OUT "$pct{$gene_name}{'Cluster 1'}\t$pct{$gene_name}{'Cluster 2'}\t$pct{$gene_name}{'Cluster 3'}\t$pct{$gene_name}{'Cluster 0'}\t";
		  print OUT "$avg{$gene_name}{'Cluster 1'}\t$avg{$gene_name}{'Cluster 2'}\t$avg{$gene_name}{'Cluster 3'}\t$avg{$gene_name}{'Cluster 0'}\t";
		  print OUT "$number_of_clusters_in_which_this_gene_is_de\t$de_line_state\t$de_line_pct_1\t$de_line_pct_2\t$de_line_diff\t$max_diff\t$de_line_logfc\t$de_line_p_val\t$de_line_adj_p\t$is_biomarker_for\t$de_in_cluster1\t$de_in_cluster2\t$de_in_cluster3\t$de_in_cluster0\t";
		  print OUT "$omim_status\t$mendeliome_status\t$ddd_green_status\t$ddd_green_and_amber_status\t$cancer_status\t$kaplanis_status\t$no_of_gene_lists\t";
		  print OUT "$known_selfish\t$already_raindanced\t$not_covered\n";
		}
	}
